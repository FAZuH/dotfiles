...
function M.lsp_attach_callback(ev)
  ...
  keymap.set("n", "<leader>lT", vim.lsp.buf.declaration, opts) -- go to declaration
  opts.desc = "show LSP definitions"
  keymap.set("n", "<leader>ly", "<cmd>Telescope lsp_definitions<CR>", opts) -- show lsp definitions
